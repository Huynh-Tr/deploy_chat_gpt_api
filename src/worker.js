/**
 * Cloudflare Worker for handling API requests and serving the web app
 */
...
<html>
<head>
    <title>AI Chat Interface - Cloudflare + Puter API</title>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        <p class="subtitle">Powered by Cloudflare Workers + Puter API</p>
